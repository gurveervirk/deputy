...
def sample_import_graph(db):
    rows = [
        ...
        },
        {
            "id": "import_stmt",
            "language": "python",
            "full_path": "pkg.utils.__import__.stmt1",
            "name": "pkg.core",
...
class TestResolveAlias:
    ...
    def test_resolve_alias_chain(self, resolver, db):
        ...
        upsert_entity(
            ...
            id="stmt_b_to_c",
            language="python",
            full_path="b.__import__.c_hello",
            name="c",
            type="IMPORT_STATEMENT",
        ...
        upsert_entity(
            ...
            id="stmt_a_to_b",
            language="python",
            full_path="a.__import__.b_hello",
            name="b",
            type="IMPORT_STATEMENT",
...
class TestRelativeImport:
    ...
    def relative_import_graph(self, db):
        ...
        upsert_entity(
            ...
            id="stmt_relative",
            language="python",
            full_path="mypkg.__import__.relative_import",
            name=".sub",
            type="IMPORT_STATEMENT",
...
class TestResolveAll:
    def test_collects_all_terminal_entities(self, db):
        ...
        upsert_entity(
            ...
            name="func",
            type="FUNCTION",
            metadata_json='{"fqn":"pkg.mod.func","lineno":1}',
        )
        upsert_entity(
            db,
            id="stmt",
            language="python",
            full_path="pkg.__import__.mod",
            name="pkg.mod",
            type="IMPORT_STATEMENT",
            metadata_json='{"import_type":"from","parent_id":"mod_a"}',
        )
    ...
    def test_all_compact_output(self, db):
        ...
        upsert_entity(
            ...
            metadata_json=json.dumps(
                {"fqn": "pkg.T", "lineno": 1, "source_id": "mod_c"}
            ),
        )
        upsert_entity(
            db,
            ...
            type="CLASS",
            metadata_json=json.dumps(
                {"fqn": "pkg.T", "lineno": 5, "source_id": "mod_c"}
            ),
        )
        db.commit()
...
class TestMultiVariant:
    ...
    def test_mixed_concrete_and_aliases_picks_correctly(self, db):
        ...
        upsert_entity(
            ...
            id="stmt_alias",
            language="python",
            full_path="mix.mod.__import__.imp",
            name="other",
            type="IMPORT_STATEMENT",
...
class TestMultiLevel:
    def test_two_level_alias_chain(self, db):
        ...
        upsert_entity(
            ...
            id="stmt_b_to_c",
            language="python",
            full_path="b.__import__.c_handler",
            name="c",
            type="IMPORT_STATEMENT",
            metadata_json='{"import_type":"from","parent_id":"mod_b"}',
        )
        ...
        upsert_entity(
            ...
            id="stmt_a_to_b",
            language="python",
            full_path="a.__import__.b_handler",
            name="b",
            type="IMPORT_STATEMENT",
            metadata_json='{"import_type":"from","parent_id":"mod_a"}',
        )
    ...
    def test_multi_level_with_branch_choices(self, db):
        ...
        for i, bid in enumerate(["stmt_mid1", "stmt_mid2", "stmt_mid3"]):
            upsert_entity(
                ...
                id=bid,
                language="python",
                full_path=f"mid.__import__.mid_{i}",
                name="bot",
                type="IMPORT_STATEMENT",
        ...
        upsert_entity(
            ...
            id="stmt_top",
            language="python",
            full_path="top.__import__.top_run",
            name="mid",
            type="IMPORT_STATEMENT",
            metadata_json='{"import_type":"from","parent_id":"mod_top"}',
        )
...
class TestControlFlowAlias:
    def test_import_alias_inside_control_flow_is_resolved(self, db):
        ...
        upsert_entity(
            ...
            id="stmt_cf",
            language="python",
            full_path="cf.__import__.stmt_cf",
            name="target",
            type="IMPORT_STATEMENT",
...
class TestResolveDisplay:
    ...
    def test_auto_trace_shows_source_path(self, db):
        ...
        upsert_entity(
            ...
            id="stmt_disp",
            language="python",
            full_path="disp.__import__.stmt",
            name="other",
            type="IMPORT_STATEMENT",
        ...
        assert (
            "disp.util  (FUNCTION util) @ disp/util.py:5" in printed
            or "disp.util  (FUNCTION util)" in printed
        )
